<template>
  <div class="editor">
    <div class="editor-top">
      ...
      <button class="btn editor-type" @click="changeEditor">切换编辑器</button>
    </div>
    <div class="">
    ...
    <div v-if="article.type === 0" class="editor-bottom">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      changeEditor() {
        console.log(1111111)
        this.article.type === 0 ? this.article.type === 1 : this.article.type === 0;
      },
      //返回
      goback() {
        this.$router.go(-1);

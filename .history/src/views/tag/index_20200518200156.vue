  ...
  <div>
    ...
    <div class="tag-container">
      <div class="tag-header">
        <span style="margin-right: 20px;" v-for="navItem in nav" ref="navItem" @click="selectNav(navItem)">
          <a href="javascript:void(0);" :class="{active:activeName === navItem}">{{navItem}}</a></span>

          ...
          <div class="detail">
            ...
            <div class="article-metas">
              ...
              <span :style="{display:[loginUserInfo.id === articleInfo.userId ? 'none' : 'inline-block']}">
                <button v-if="token === undefined" class="btn follow-btn" @click="follow">关注</button>
                <button v-else class="btn unFollow-btn">已关注</button>
              </span>
            </div>
...
<script>
  ...
  import {getUserInfo, getFollowIds} from '@/api/user'
  export default {
    name: 'Detail',
    components: {
      NavBar,
        ...
        if (this.token != undefined) {
          ...
          getFollowIds(data).then(resp => {
            ...
            follows.forEach(follow => {
              console.log(typeof this.articleInfo.userId)
              console.log(typeof follow)
              if (this.articleInfo.userId === follow) {
                
                this.isFollow = true
                console.log(this.articleInfo.userId)
              }
            });

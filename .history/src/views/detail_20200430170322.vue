        ...
        <article class="info">
          <div class="detail">
            ...
            <div class="article-metas">
              ...
              <button v-if="token === '' || token === undefined" class="btn follow-btn" @click="follow">关注</button>
              <button v-if="loginUserInfo.id === articleInfo.userId" class="btn follow-btn" @click="follow">关注</button>

       ...
       <div class="setting-profile" v-if="displayContent === 2">
         ...
         <el-form :model="user" label-width="100px" label-position="left">
           <el-form-item label="旧密码">
             <el-input v-model="user.username" placeholder="请输入原密码" size="small" style="width: 50%;">
             </el-input>
           </el-form-item>
           <el-form-item label="新密码">
             <el-input v-model="user.nickName" placeholder="新密码" size="small" style="width: 50%;"></el-input>
           </el-form-item>
           <el-form-item label="确认密码">
             <el-input v-model="user.note" placeholder="确认新密码" size="small" style="width: 50%;"></el-input>
           </el-form-item>
         </el-form>
         <el-button type="primary" size="small" @click="save">保存</el-button>
       </div>

       ...
       <div class="setting-profile" v-if="displayContent === 2">
         ...
         <el-form :model="user" label-width="100px" label-position="left">
           <el-form-item label="旧密码">
             <el-input v-model="oldPassword" placeholder="请输入原密码" show-password size="small" style="width: 50%;">
             </el-input>
           </el-form-item>
           <el-form-item label="新密码">
             <el-input v-model="newPassword" placeholder="新密码" show-password size="small" style="width: 50%;">
             </el-input>
           </el-form-item>
           <el-form-item label="确认密码">
             <el-input v-model="confirmPassword" placeholder="确认新密码" show-password size="small" style="width: 50%;">
             </el-input>
           </el-form-item>
         </el-form>
    ...
    methods: {
      ...
      update() {
        if (this.username === null || this.username === '') {
          this.$message({type: 'warn', message: '用户名不能为空'})
        }
        if (this.oldPassword === null || this.oldPassword === '') {
        this.$message({type: 'warn', message: '原密码不能为空'})
        }
        if (this.newPassword === null || this.newPassword === '') {
        this.$message({type: 'warn', message: '新密码不能为空'})
        }
        let data = {

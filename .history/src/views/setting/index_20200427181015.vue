  ...
  <div>
    ...
    <div class="setting-box">
      <div class="setting-profile" v-if="displayContent === 1">
        ...
        <el-button class="setting-btn" type="primary" size="small" @click="save">保存</el-button>
      </div>
      <div class="setting-profile" v-if="displayContent === 2">
        ...
        <el-button class="setting-btn" type="primary" size="small" @click="update">保存修改</el-button>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 修改密码
      update() {
        if (this.passwordForm.oldPassword === null || this.passwordForm.oldPassword === '' || this.passwordForm
          .newPassword ===

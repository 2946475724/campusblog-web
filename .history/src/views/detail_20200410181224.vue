      ...
      <div class="main-content">
        <article class="info">
          <div class="detail">
            ...
            <div v-if="articleInfo.type === 0" class="article-content markdown-body" codeStyle="monokai" v-html="articleInfo.contentHtml">
            ...
            <div class="tool-box">
              <span class="tool-box-item">
                <svg-icon icon-class="like" class="icon-size"></svg-icon> 点赞
              </span>
              <span class="tool-box-item">

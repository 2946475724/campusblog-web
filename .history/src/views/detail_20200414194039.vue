      ...
      <div class="main-content">
        <article class="info">
          <div class="detail">
            ...
            <mavon-editor v-if="articleInfo.type === 1" style="box-shadow: '';"
            ...
            <div class="tool-box">
              <span class="tool-box-item" @click="like">
                <svg-icon v-if="articleInfo.likeStatus === 0 || articleInfo.likeStatus === null" icon-class="like"
                  class="icon-size"></svg-icon>
                <svg-icon v-if="this.token != undefined && articleInfo.likeStatus === 1" icon-class="like-active" class="icon-size"></svg-icon> 
                点赞{{articleInfo.likes}}
              </span>
              <span class="tool-box-item">
                <svg-icon icon-class="collection" class="icon-size"></svg-icon> 收藏
              </span>
            </div>
          </div>
...
<script>
  ...
  import {getArticleById, likeArticle} from '@/api/article';
  ...
  export default {
    ...
    created() {
      ...
      this.getArticleById();
      this.getCommentList();
      this.token = getToken('loginToken');

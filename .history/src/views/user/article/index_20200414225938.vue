    ...
    <div class="article-box">
      <div class="article-item" v-for="(item, index) in articles" :key="index">
        ...
        <div class="meta">
          ...
          <el-popover placement="top" width="160" :visible = "false" trigger="click">
            <p>这是一段内容这是一段内容确定删除吗？</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" type="text" @click="visible = false">取消</el-button>
              <el-button type="primary" size="mini" @click="deleteSubmit(item.id)">确定</el-button>
            </div>
            <span class="meta-delete" @click="visible = true" slot="reference">删除</span>
          </el-popover>
        </div>
      </div>
    </div>

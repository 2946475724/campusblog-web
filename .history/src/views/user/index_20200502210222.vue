  ...
  <div>
    ...
    <div class="main-container">
      <div class="main-content">
        ...
        <div class="list-box">
          <el-tabs v-model="activeName" @tab-click.sync="handleClick">
            <el-tab-pane label="文章" name="tab1">
              <Article :articleList="articleList" v-if="articleList!=undefined"></Article>
            </el-tab-pane>
            <el-tab-pane label="我的收藏" name="tab2">
              <Collection :collectArticleList="collectArticleList" v-if="collectArticleList!=undefined"></Collection>
            </el-tab-pane>

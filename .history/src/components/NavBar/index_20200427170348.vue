  ...
  <div class="header-container">
    <header class="header">
      ...
      <ul class="header-list">
        <li v-for="(navItem, index) in nav" @click="selectNav(navItem)" :key="index">
          <router-link :to="navItem.url" :active-class="{'active':activeName === navItem.name}">
            {{navItem.name}}
          </a>
        </li>
      </ul>

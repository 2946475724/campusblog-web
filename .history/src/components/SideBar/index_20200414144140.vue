        ...
        <div class="list">
          <ul class="aside-article-list" v-for="(item, index) in hotArticles" :key="index">
            <li class="item">
              ...
              <span class="rank-num" v-else-if="index === 1" style="background-color: yellowgreen;">{{index + 1}}</span>
              <span class="rank-num" v-else-if="index === 2" style="background-color: greenyellow;">{{index + 1}}</span>
